...
class Serie
{
    ...
    /**
     * @Assert\NotBlank(message=" Inserez le nom de la série !")
     * @Assert\Length( min=2, max=255,
     *     minMessage="trop court! au moins 2 caracteres")
    ...
    public function setDateModified(?\DateTimeInterface $dateMotified): self
    {
